...
# --- Configuration ---
LOG_DIR="/mnt/data/project/2025_trimmomatic/trimmomatic_paper/logs/scaling_fastp-v1.1.0-no-adapters"
OUT_DIR="/mnt/data/project/2025_trimmomatic/trimmomatic_paper/analysis/scaling_fastp-v1.1.0-no-adapters"
...
for t in "${THREAD_COUNTS_P[@]}"; do
    run_benchmark "fastp-v1.1.0"       "$t" "Plant" "$PLANT_R1" "$PLANT_R2"
done
...
for t in "${THREAD_COUNTS_H[@]}"; do
    run_benchmark "fastp-v1.1.0"       "$t" "Human" "$HUMAN_R1" "$HUMAN_R2"
done
