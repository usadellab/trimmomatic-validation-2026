...
# --- Configuration ---
LOG_DIR="/mnt/data/project/2025_trimmomatic/trimmomatic_paper/logs/scaling_fastp-v1.3.3"
OUT_DIR="/mnt/data/project/2025_trimmomatic/trimmomatic_paper/analysis/scaling_fastp-v1.3.3"
...
# Threads to test
THREAD_COUNTS_P=(240 160 80 40 16 8 4 2 1)

# 1. PLANT DATASET LOOP
echo "=========================================================="
echo "STARTING PLANT DATASET"
echo "=========================================================="
for t in "${THREAD_COUNTS_P[@]}"; do
    run_benchmark "fastp-v1.3.3-adapters"       "$t" "Plant" "$PLANT_R1" "$PLANT_R2"
done

THREAD_COUNTS_H=(240 160 80 40 16 8 4 2 1)
# 2. HUMAN DATASET LOOP
echo "=========================================================="
echo "STARTING HUMAN DATASET"
echo "=========================================================="
for t in "${THREAD_COUNTS_H[@]}"; do
    run_benchmark "fastp-v1.3.3-adapters"       "$t" "Human" "$HUMAN_R1" "$HUMAN_R2"
done
