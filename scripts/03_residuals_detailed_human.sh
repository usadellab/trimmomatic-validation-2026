...
#$ -j y
#$ -o /mnt/data/project/2025_trimmomatic/trimmomatic_paper/logs/adapter_assessment_detailed_human.log
#$ -pe smp 40
#$ -l h_vmem=1G
#$ -l h_rt=02:00:00
...
RESIDUAL_OUT_DIR="/mnt/data/project/2025_trimmomatic/trimmomatic_paper/analysis/residuals_detailed_human"
...
# Trimmomatic
FILES_R1["Trimmomatic"]="${ANALYSIS_DIR}/Human_Trimmomatic_40t_R1.fq.gz"
FILES_R2["Trimmomatic"]="${ANALYSIS_DIR}/Human_Trimmomatic_40t_R2.fq.gz"

# fastp
FILES_R1["fastp"]="${ANALYSIS_DIR}/Human_fastp_40t_R1.fq.gz"
FILES_R2["fastp"]="${ANALYSIS_DIR}/Human_fastp_40t_R2.fq.gz"

# BBDuk
FILES_R1["BBDuk"]="${ANALYSIS_DIR}/Human_BBDuk_40t_R1.fq.gz"
FILES_R2["BBDuk"]="${ANALYSIS_DIR}/Human_BBDuk_40t_R2.fq.gz"

# Skewer
FILES_R1["Skewer"]="${ANALYSIS_DIR}/Human_skewer_40t_out-trimmed-pair1.fastq.gz"
FILES_R2["Skewer"]="${ANALYSIS_DIR}/Human_skewer_40t_out-trimmed-pair2.fastq.gz"

# Cutadapt
FILES_R1["Cutadapt"]="${ANALYSIS_DIR}/Human_Cutadapt_40t_R1.fq.gz"
FILES_R2["Cutadapt"]="${ANALYSIS_DIR}/Human_Cutadapt_40t_R2.fq.gz"

# RabbitTrim
FILES_R1["RabbitTrim"]="${ANALYSIS_DIR}/Human_RabbitTrim_40t_out.read1_p.gz"
FILES_R2["RabbitTrim"]="${ANALYSIS_DIR}/Human_RabbitTrim_40t_out.read2_p.gz"
